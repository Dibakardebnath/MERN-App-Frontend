...
export const About = () => {
  ...
  return (
    <Box>
      ...
      <Text className="welcome-heading">
      ...
      <Box className="image-gallery">
        <Image
          className="sliderGif"
          src="https://i.makeagif.com/media/2-07-2017/JTG6s-.gif"
        ></Image>
      </Box>
      <Heading mt={"20px"}>Our Mission</Heading>
      <Text className="mission-text">
        Our mission is to empower individuals with valuable knowledge by
        providing a platform for insightful and informative blog content. We aim
        to foster a community where people can share their expertise,
        experiences, and ideas to inspire and educate others. Inspiring
        Creativity: We are dedicated to fostering creativity through our blog
        app.
      </Text>
