  ...
  const closeModal = () => {
   ...
   const [pageNo,setPageNo]=useState(1)
    ...
    const handleOrder=(value) => {
      switch(value){
        case "asc":return setOrder("asc")
        case "desc":return setOrder("desc")
        default: throw new Error("invalid")
      }
    }
...
>
  ...
  <Box className='modal-edit'>
    ...
    <FormControl>
      ...
      <Input type="text" placeholder='category'  name='category' value={updateVal.category} onChange={(e)=>setUpdateVal({...updateVal,[e.target.name]:e.target.value})}/>
      <Input type="text" placeholder='description'  name='description' value={updateVal.description} onChange={(e)=>setUpdateVal({...updateVal,[e.target.name]:e.target.value})}/>
